...
import { deleteCartItemAsync, selectCart, updateCartAsync } from "../features/Cart/cartSlice";
import { createOrderAsync, selectOrderPlaced } from '../features/order/orderSlice';
  // More products...
const Checkout = () => {
   const {
     register,
...
const dispatch = useDispatch()
  ...
  return (
    <>
      ...
      {orderPlaced && <Navigate to={`/orderSuccess/${orderPlaced.id}`} replace={true}></Navigate>}
