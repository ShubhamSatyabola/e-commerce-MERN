...
import { clearSelectedProduct, createProductAsync, fetchProductByIdAsync, selectBrands, selectCategories, selectProductById, updateProductAsync } from "../Product-list/product-list-slice";
...
export default function ProductForm() {
 ...
 const handleDelete = () =>{
  ...
  return (
    ...
    >
      <div class="space-y-12 bg-white px-2">
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  {brands.map((brand, index) => {
                    return <option key={index}>{brand.value}</option>;
                  })}
                </select>
                {errors.brand && (
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  {categories.map((category, index) => {
                    return <option key={index}>{category.value}</option>;
                  })}
                </select>
                {errors.category && (
